...
// Here we are finding the length of the string and the loop iterates based on the condition

				for(int i=str.length()-1;i>=0;i--)

//charAt() method returns a character from the specified location.
