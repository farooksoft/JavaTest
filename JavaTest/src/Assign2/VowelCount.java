...
class CheckVowels
{
	...
	CheckVowels()    //default constructor used to initialize the instance variables
	{
...
//this method reads a line of text and it checks each character for vowel
	void readString()
	{
		...
		try        //readLine() method throws IOException so it should be written in try,catch
		{
		str=br.readLine();   //reads a line of text
		}
		catch(IOException ioe){ }    //exception is handled

//the below loop iterates from the first character to the end of the string

		for(int i=0;i<str.length();i++)     //str.length gets the no.of characters in the string object
		{
			if(str.charAt(i)=='a' || str.charAt(i)=='A') //checks if the character is 'a' or 'A'
				a_count++;        //if the character is a or A increment a_count variable
			if(str.charAt(i)=='e' || str.charAt(i)=='E')
				e_count++;        //if the character is e or E increment e_count variable
			if(str.charAt(i)=='i' || str.charAt(i)=='I')
				i_count++;        //if the character is i or I increment i_count variable
			if(str.charAt(i)=='o' || str.charAt(i)=='O')
				o_count++;        //if the character is o or O increment o_count variable
			if(str.charAt(i)=='u' || str.charAt(i)=='U')
				u_count++;        //if the character is u or U increment u_count variable
		}
	}

	void showCount()    //method to display the no.of times a particular vowel occurs
	{
...
class VowelCount
{
	...
	{
		CheckVowels chk=new CheckVowels(); //creating an instance of CheckVowels class
