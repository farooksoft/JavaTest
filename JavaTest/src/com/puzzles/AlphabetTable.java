...
/* NOTE: This program works well for an alphabet count upto 20.if needed beyond that the program can be enhanced for the purpose */
...
public class AlphabetTable {
	public static void main(String[] args) {
		...
		// calling the countLetters and display method using Alphabets class
		// object
		al.countLetters();
		al.display();
	}
