...
public class OrbitSettings extends Dialog implements ActionListener,
	...
	OrbitSettings(Frame parent) {
		...
		passwordWarningLabel1.setVisible(parentWindow.requirePassword
				&& !parentWindow.passwordEncryptor.canEncrypt);
	...
	private void setValues() {
		...
		if (parentWindow.requirePassword) {
			...
			parentWindow.encryptedPassword = parentWindow.passwordEncryptor
	...
	public void keyReleased(KeyEvent E) {
		if (E.getKeyCode() == E.VK_ENTER) {
			if ((E.getSource() == ok) || (E.getSource() == name)
					|| (E.getSource() == password) || (E.getSource() == port)
					|| (E.getSource() == host)) {
				setValues();
				dispose();
				return;
