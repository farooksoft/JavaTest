...
public class OrbitInfoDialog extends Dialog implements ActionListener,
	...
	public OrbitInfoDialog(Frame parent, String TheTitle, boolean IsModal,
			String TheMessage) {
		...
		setLocation(
				(((((parentFrame.getBounds()).width) - ((getSize()).width)) / 2) + ((parentFrame
						.getLocation()).x)),
				(((((parentFrame.getBounds()).height) - ((getSize()).height)) / 2) + ((parentFrame
						.getLocation()).y)));
