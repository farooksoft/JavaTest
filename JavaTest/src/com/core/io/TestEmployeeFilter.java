...
public class TestEmployeeFilter {
	...
	public static void employeeFilter() {
		...
		case 2:
			...
			case 1:
				System.out
						.println("Please enter Employee Age and filters like ..");
			...
			case 2:
				System.out
						.println("Please enter Employee Name(Pattern) and filters like ..");
				System.out
			...
			case 3:
				System.out
						.println("Please enter Employee Designation and filters like ..");
				System.out.println("1. < \n2. > ");
...
/**
 * it is a utility class to compare employee objects based on different
 * prperties
 * 
 * @author srinath.rayabarapu
 */
