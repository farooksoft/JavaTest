...
public class TestExpressionEvaluation {
	...
	public static void expressionEvaluation() {
		...
		String inputFile1Path = "D:/WorkSpace/JavaPractice/src/com/core/io/Input1.txt";
		String inputFile2Path = "D:/WorkSpace/JavaPractice/src/com/core/io/Input2.txt";
		String exprFile = "D:/WorkSpace/JavaPractice/src/com/core/io/Expr.txt";
	 ...
	 * @return List<Double>
	 */
	private static List<Double> getInputFileDataList(String inputFile) {
	...
	/**
	 * reads Expression file and returns a map with an integer and file data list as key value pairs
	 * @param exprFile
	 * @param file1DataList
	 * @param file2DataList
	 * @return Map<Integer,List<Object>>
	 */
	private static Map<Integer, List<String>> getExpressionFileData(
			String exprFile, List<Double> file1DataList,
			List<Double> file2DataList) {
...
//				System.out.println("File Line : " + fileLine);
				...
				while (stringTokenizer.hasMoreElements()) {
					...
					if(tempToken.contains("Input1")) {
						...
						modifiedExprlist = getModifiedExpressionList(tempToken,file1DataList,modifiedExprlist);
						
					} else if(tempToken.contains("Input2")) {
						
						modifiedExprlist = getModifiedExpressionList(tempToken,file2DataList,modifiedExprlist);
...
//				System.out.println("-------------------------");
	 ...
	 * @param list
	 */
	private static void printFileData(List<String> list) {
...
//			System.out.println(temp);
	 ...
	 * @return List<Object>
	 */
	private static List<String> getModifiedExpressionList(String tempToken, List<Double> fileDataList, List<String> modifiedExprlist){
	 ...
	 * @param list
	 */
    public static void evaluateExpression(List<String> list) {
...
//                	System.out.println("Pushed value into val stack "+Double.parseDouble(temp));
        ...
        System.out.println("Final Value : "+Double.valueOf(twoDForm.format(vals.pop())));
    }
}
