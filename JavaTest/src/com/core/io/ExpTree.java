...
public class ExpTree	{
	...
	private double evaluateV2(ExpNode subTree)
	{
		...
		if(subTree.data.equals("+"))
		{
			...
			else
			{
				...
				System.out.println("subTreeLeftData: " + subTreeLeftData + " subTreeRightdata: " + subTreeRightData);
	...
	//toString() - toString method for Exp Tree Uses Print Tree to print the Tree
