...
//	public static final String DEFAULT_ENCRYPTION_KEY	= "This is a fairly long phrase used to encrypt";
	...
	public FileDataEncrypterDecryptor( String encryptionScheme ) throws EncryptionException	{
		this( encryptionScheme, DEFAULT_ENCRYPTION_KEY );
	}

	public FileDataEncrypterDecryptor( String encryptionScheme, String encryptionKey )
	...
	public void encrypt( String encrFilePath, String decrFilePath ) throws EncryptionException	{
		...
		if ( encrFilePath == null || encrFilePath.trim().length() == 0 || decrFilePath == null || decrFilePath.trim().length() == 0 )
				throw new IllegalArgumentException("unencrypted file path was null or empty" );
...
//				StringTokenizer tokenizer = new StringTokenizer(encryptedStringToken,"=");
...
//				return new String(Base64.encodeBase64( ciphertext ));
				...
				String tempString = "Key"+i+"="+new String(Base64.encodeBase64(ciphertext))+"\n";
...
//				byte[] cleartext = Base64.decodeBase64( enctext );
	...
	public static void main(String[] args) {
		try {
			FileDataEncrypterDecryptor fileEncrypterDectyptor = new FileDataEncrypterDecryptor("DES");
